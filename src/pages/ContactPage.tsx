...
export default function ContactPage() {
  const { site, lguName, hotlines, formatPhoneLink } = useSiteConfig();
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div className="flex items-center gap-3 p-6 border-b border-gray-200 bg-gray-50">
              <i className="bi bi-clock-fill text-2xl text-primary-600" />
            ...
            <div className="divide-y divide-gray-100">
              <div className="flex items-center justify-between p-4 bg-green-50">
                ...
                <span className="inline-flex items-center gap-1 text-green-600 text-sm font-medium">
                  <i className="bi bi-check-circle-fill" /> Open
                </span>
              </div>
              <div className="flex items-center justify-between p-4 bg-yellow-50">
                ...
                <span className="inline-flex items-center gap-1 text-yellow-600 text-sm font-medium">
                  <i className="bi bi-pause-circle-fill" /> Break
                </span>
              </div>
              <div className="flex items-center justify-between p-4 bg-red-50">
                ...
                <span className="inline-flex items-center gap-1 text-red-600 text-sm font-medium">
                  <i className="bi bi-x-circle-fill" /> Closed
                </span>
              </div>
              <div className="flex items-center justify-between p-4 bg-red-50">
                <span className="font-medium text-gray-900">
              ...
              {hotlines.emergency
                ...
                .map((hotline) => (
                  <a
                    ...
                    className="flex flex-col items-center gap-2 p-6 bg-red-50 border border-red-200 rounded-xl no-underline text-center transition-all duration-200 hover:border-red-400 hover:shadow-md"
                  >
                    <i className={`bi ${hotline.icon} text-3xl text-red-600`} />
              ...
              {hotlines.government
                ...
                .map((hotline) => (
                  <a
                    key={hotline.id}
                    href={`tel:${formatPhoneLink(hotline.number)}`}
                    className="flex flex-col items-center gap-2 p-6 bg-blue-50 border border-blue-200 rounded-xl no-underline text-center transition-all duration-200 hover:border-blue-400 hover:shadow-md"
                  >
                    <i
                      className={`bi ${hotline.icon} text-3xl text-blue-600`}
                    />
                    <span className="text-sm font-medium text-gray-700">
                      {hotline.name}
                    </span>
              ...
              {hotlines.utilities
                ...
                .map((hotline) => (
                  <a
                    key={hotline.id}
                    href={`tel:${formatPhoneLink(hotline.number)}`}
                    className="flex flex-col items-center gap-2 p-6 bg-gray-50 border border-gray-200 rounded-xl no-underline text-center transition-all duration-200 hover:border-gray-400 hover:shadow-md"
                  >
                    <i
                      className={`bi ${hotline.icon} text-3xl text-gray-600`}
                    />
                    <span className="text-sm font-medium text-gray-700">
                      {hotline.name}
                    </span>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              <span className="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-3">
                <i className="bi bi-hospital-fill" /> Medical
              </span>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Medical Emergency Hotlines
              </h2>
              ...
              {hotlines.medical
                ...
                .map((hotline) => (
                  <a
                    key={hotline.id}
                    href={`tel:${formatPhoneLink(hotline.number)}`}
                    className="flex flex-col items-center gap-2 p-6 bg-green-50 border border-green-200 rounded-xl no-underline text-center transition-all duration-200 hover:border-green-400 hover:shadow-md"
                  >
                    <i
                      className={`bi ${hotline.icon} text-3xl text-green-600`}
                    />
                    <span className="text-sm font-medium text-gray-700">
                      {hotline.name}
                    </span>
          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              <div className="text-center max-w-md mx-auto">
                <i className="bi bi-telephone-fill text-5xl text-gray-300 mb-4 block" />
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  Hotlines Coming Soon
                </h3>
                <p className="text-gray-500">
                  Emergency and medical hotlines for {lguName} will be added
                  soon.
                </p>
              </div>
            </div>
