...
export default function AccessibilityPage() {
  ...
  usePageMeta({ title: 'Accessibility' });
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto">
            <span className="inline-flex items-center gap-2 bg-white/20 text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
              <i className="bi bi-universal-access" /> Accessibility
            </span>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {t('access-title') || 'Accessibility Statement'}
            </h1>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex justify-center">
              <div className="inline-flex items-center gap-4 bg-green-50 border border-green-200 px-6 py-4 rounded-xl">
                <i className="bi bi-check-circle-fill text-3xl text-green-600" />
                <div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">
                {t('access-commitment') || 'Our Commitment'}
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Better {lguName} is committed to ensuring digital accessibility
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">
                {t('access-limitations') || 'Known Limitations'}
              </h2>
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-600">
                  <i className="bi bi-exclamation-circle text-yellow-500 mt-0.5" />
                  <span>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">
                {t('access-alternative') || 'Alternative Access'}
              </h2>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 p-4 bg-primary-50 border border-primary-200 rounded-xl text-primary-700 font-medium hover:bg-primary-100 transition-colors"
              >
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">
                {t('access-technical') || 'Technical Specifications'}
              </h2>
            ...
            <div className="bg-primary-50 border border-primary-200 rounded-2xl p-8 flex items-start gap-4">
              <i className="bi bi-heart-fill text-3xl text-primary-600 shrink-0" />
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                  {t('access-promise') || 'Our Promise'}
                </h3>
                <p className="text-gray-600">
                  Better {lguName} is committed to ensuring that our digital
                  services are accessible to all citizens, regardless of
                  ability. We view accessibility not as a feature, but as a
                  fundamental right.
                </p>
              </div>
            </div>
