              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <i className="bi bi-shield-check text-2xl text-green-600" />
                ...
                >
                  ...
                  <p className="text-gray-600">
                    ...
                    third parties. We may share information only with service
                    providers, when required by law, or with your explicit
                    consent.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    ...
                    last contact. Server logs are automatically deleted after 90
                    days.
                  </p>
                </section>
