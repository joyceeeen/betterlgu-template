            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden transition-all duration-200 hover:border-primary-500 hover:shadow-lg">
              ...
              <div className="p-6 space-y-3">
                ...
                <span className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg text-gray-700">
                  <i className="bi bi-clock text-primary-600" /> Mon-Fri: 8:00 AM - 5:00 PM
                </span>
              </div>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-1 text-xs text-gray-500">
                      {dept.phone && <span className="flex items-center gap-1"><i className="bi bi-telephone" /> {dept.phone}</span>}
                      {dept.email && <span className="flex items-center gap-1"><i className="bi bi-envelope" /> {dept.email}</span>}
                    </div>
