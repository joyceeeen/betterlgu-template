      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Link to="/legislative/ordinance-framework" className="group bg-white border border-gray-200 rounded-xl p-8 no-underline transition-all duration-200 hover:border-primary-500 hover:shadow-lg">
            ...
            <Link to="/legislative/resolution-framework" className="group bg-white border border-gray-200 rounded-xl p-8 no-underline transition-all duration-200 hover:border-primary-500 hover:shadow-lg">
              <div className="w-14 h-14 flex items-center justify-center bg-primary-50 rounded-xl text-primary-600 text-2xl mb-4 transition-all duration-200 group-hover:bg-primary-600 group-hover:text-white">
