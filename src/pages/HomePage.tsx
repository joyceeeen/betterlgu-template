          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {site.contact.phone && (
              <a
                ...
                className="group flex items-start gap-4 p-6 bg-white border border-gray-200 rounded-xl no-underline text-gray-800 transition-all duration-200 hover:border-primary-500 hover:shadow-md"
              >
