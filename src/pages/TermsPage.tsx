            ...
            <aside className="lg:w-64 shrink-0">
              <div className="sticky top-24 bg-white border border-gray-200 rounded-xl p-6">
                <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <i className="bi bi-list-ul" /> Contents
                </h4>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    {siteTitle} is a civic platform dedicated to empowering the
                    people of {lguName} by providing transparent access to the
                  ...
                  <div className="flex items-center gap-3 p-4 bg-pink-50 border border-pink-200 rounded-lg">
                    <i className="bi bi-heart-fill text-2xl text-pink-600" />
                    <span className="text-pink-800">
                      This platform is provided <strong>free of charge</strong>{' '}
                      as a public service.
                    </span>
                  </div>
                </section>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    ...
                    continued use of the site signifies your ongoing acceptance
                    of this agreement.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    ...
                    operators, volunteers, and contributors shall not be liable
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    information, reviewing source links, and cross-checking with
                ...
                >
                  ...
                  <p className="text-gray-600">
                    ...
                    legal, medical, financial, or any other form of professional
                    advice.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    {siteTitle} cannot guarantee that the website will be
                    available or accessible at all times, error-free, or fully
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mt-8">
                    {siteTitle} provides public domain information to support
                    civic engagement, transparency, and informed participation
                    in local governance.
                  </p>
                </section>
              </div>
